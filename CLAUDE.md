...
- **Baselines canónicos** (commits limpios): Seasonal Naive `obesidad_benchmark_full_7952e226c10a` @ `cf97301b`; run conjunto 5 motores `obesidad_benchmark_full_fc70f5f15b7b` @ `1e0709fd`; run 6 motores `obesidad_benchmark_full_6ff688593915` @ `52fc07af`; **run vigente 7 motores `obesidad_benchmark_full_b0c4b6e18c50` @ `7ff41b04`**. Mediana sMAPE_all: naive 39.5 · median_3y 36.7 · mean_3y 32.5 · ETS 30.0 (−24%) · median_5y 28.3 · **mean_5y 28.02 (−29.01%)** · **Ridge 28.00 (−29.07%)**; en las 64 bases: mean_5y 28.99 < Ridge 29.70 ≈ median_5y 29.71 < ETS 30.50. Cada motor: 13,312 predicciones base / 23,088 derivadas / 444 métricas / **solo 64 modeladas**; ETS 256/256 `primary` convergidos (19.4 s), Ridge 256 refits exteriores + 2,304 ajustes internos = **2,560 Ridge**, 9/9 candidatos válidos siempre (3.7 s); `n_train` por fold 366/418/470/522. Los 6 motores previos conservan `metrics.csv` **byte-idéntico**. Verificado reproducible: mismo `run_id` y los 30 artefactos con el mismo digest en otro `runs_root`. **Sigue sin elegirse ganador.**
