...
% Nombres, orden, afiliaciones y correos copiados de la ficha de CMT (consultada
% 20-ago-2026): la carta de aceptacion exige que el camera-ready y CMT coincidan.
% CMT registra dos instituciones -- ITESM para los cuatro primeros, IMSS para Ruth --
% y las formas cortas de los nombres, sin guion en los apellidos compuestos.
...
% PROVISIONAL: el texto exacto de la afiliacion del Tec queda pendiente del PDF
% institucional. Lo demas de este bloque ya es definitivo contra CMT.
\institute{Tecnol\'ogico de Monterrey, Monterrey, Nuevo Le\'on, Mexico\\
