...
deterministically. Table~\ref{tab:hparams} lists the per-model
hyperparameters; the configuration files, the pseudocode and the
per-state table are in the repository cited in Sect.~\ref{ssec:eval}.

\begin{table}[!h]
\centering
\caption{Principal hyperparameters, fixed before the 2026 evaluation.}
\label{tab:hparams}
