...
% =====================================================================
\begin{abstract}
Weekly forecasting of reported psychiatric incidence is hard because surveillance
...
per year~\cite{sinave2026}. Despite the routine availability of weekly
case counts, psychiatric-service planning remains largely
\emph{reactive}: without a prospective trajectory, surges in reported cases
become visible in the bulletin only after they have occurred.
...
2020--2021, whose shift these counts cannot apportion between reporting
and disease; and a post-pandemic regime in 2022--2025 that exceeds
