...
already visible in the bulletin, producing recurrent demand peaks
...
deterministically. The per-state out-of-sample table, the frozen
assignment and the ablation of Sect.~\ref{ssec:ablation} are reproducible
from the repository cited in Sect.~\ref{ssec:eval}.
