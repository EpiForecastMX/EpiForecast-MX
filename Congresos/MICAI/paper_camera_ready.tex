...
\emph{reactive}: without a prospective trajectory, demand surges become
visible in the bulletin only after they have occurred.
...
\emph{reported} demand: a planning figure taken from the national mean alone
...
capacity planning for the February--May demand peak and male-targeted
help-seeking campaigns in quieter months. We
...
target is therefore reported demand, which is what the panel measures;
whether reported demand is the right planning target is a health-services
question this study does not address. The framework should not be read as
