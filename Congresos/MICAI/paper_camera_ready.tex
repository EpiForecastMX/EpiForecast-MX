...
on cross-validated accuracy, can reassign low-incidence series to a
regional model, and records every decision in a justified log. We instantiate it for weekly depression
