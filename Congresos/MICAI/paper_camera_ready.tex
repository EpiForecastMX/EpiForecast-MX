...
seasonal persistence, the same male series sit between 0.73 and 0.90
...
and the four models converge, with per-series medians of $26.4\%$ for
Prophet, $27.9\%$ for DeepAR, $28.3\%$ for Ensemble, and $29.3\%$ for
...
window (W02--W18); a per-state out-of-sample table over the same window
