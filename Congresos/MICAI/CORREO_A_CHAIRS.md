...
> Dear Program Chairs,
>
> Regarding submission #12, *Forecasting Weekly Depression Incidence in Mexico: A
> Multi-Model Framework with Auditable Per-Series Model Selection*, accepted for oral
> presentation.
>
...
>
> **Affiliations.** CMT lists the first four authors under "ITESM". That form is
> explicitly not accepted by our institution's affiliation guidelines (TEC-II-05), which
...
Si prefieres escribirlo en español, adelante: los dos chairs son mexicanos. Lo único que
conviene conservar es la tabla y la frase de que **no hay cambio de autoría**, porque eso
es lo que decide si lo tratan como trámite o como excepción.
