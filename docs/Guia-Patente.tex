...
{\color{soft}\footnotesize Generado por \texttt{scripts/build\_patent\_bundle.sh}\ \textbullet\ $\sim$262 archivos / 2.4 MB\ \textbullet\ \texttt{EpiForecastMX/EpiForecast-MX-Patente}}
\end{center}
